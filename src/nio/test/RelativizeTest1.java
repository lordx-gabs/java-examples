...
public class RelativizeTest1 {
    public static void main(String[] args) {
        ...
        Path clazz = Paths.get("/home/gabs/hello/Test1.java");
        Path pathToClazz = dir.relativize(clazz);
        System.out.println(pathToClazz);

        Path absolute1 = Paths.get("/home/gabs");
        Path absolute2 = Paths.get("/usr/local");
        Path absolute3 = Paths.get("/home/gabs/hello/Test1.java");
        Path relative1 = Paths.get("temp");
        Path relative2 = Paths.get("temp/temp.849190231");
